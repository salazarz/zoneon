...
<div class="wrapper pa-0">
    <header class="sp-header">
        ...
        <div class="form-group mb-0 pull-right">
            ...
            <a class="inline-block btn btn-info btn-success btn-rounded btn-outline" href="{{route('register')}}">Sign Up</a>
        </div>
                    ...
                    <div class="auth-form  ml-auto mr-auto no-float">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="mb-30">
                                    <h3 class="text-center txt-dark mb-10">Sign in to Zone One</h3>
