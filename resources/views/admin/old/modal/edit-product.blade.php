<!--  Edit Client-->
<div id="edit-product-modal{{$data->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      ...
      <div class="modal-body">
        <form method="POST" action="{{ route('product.update',$data) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="price" type="number" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ $data->price}}" required min="0">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="discount" type="number" class="form-control{{ $errors->has('discount') ? ' is-invalid' : '' }}" value="{{ $data->discount}}" name="discount">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="stock" type="number" class="form-control{{ $errors->has('stock') ? ' is-invalid' : '' }}" value="{{ $data->stock}}" name="stock">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="image" type="file" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="product_images[]" multiple>
